...
String outputHTML="";
try{
	isValideChecksum = CheckSumServiceHelper.getCheckSumServiceHelper().verifycheckSum("U8kaIIv&0PEkgpWH",parameters,paytmChecksum);
...
System.out.println(user_email+start_date+end_date);
...
msg.setText("Dear Vendor, Your bike with name"+" "+bike_name+" " +"booking has been confirmed by "+" "+ uname+" "+" FROM:"+" "+start_date+"-"+" "+"TO:"+" "+end_date);
...
msg.setSubject(" Regarding Booking");
msg.setText("Dear "+" "+uname+" Bike named"+" "+bike_name+" " +"booking has been confirmed. "+" Address of pickup:"+address );
msg.setSentDate(new Date());
Transport.send(msg);
System.out.println("Message sent.");
}catch (MessagingException e){ System.out.println("ERROR, cause: " + e);
